...
angular.module("ramblApp.navbar",[]).controller("navbarController",["$scope","$location","Auth",function(n,e,t){n.signout=function(){t.signout(),n.data.username=t.getUsername()},n.getUsername=t.getUsername,n.isLoggedIn=function(){return t.getUsername()},n.isActive=function(n){return"/login"===n&&-1!==e.path().indexOf("/login")?"#/login":"/signup"===n&&-1!==e.path().indexOf("/signup")?"#/signup":n===e.path()}}]);
